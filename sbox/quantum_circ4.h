#ifndef QUANTUM_CIRC4_H
#define QUANTUM_CIRC4_H
...
void qt2(qubit *a, qubit *b, qubit *d) {
    ...
    cx(a[1], a[0]);
    cx(b[1], b[0]);
    QAND(a[0], b[0], d[0], d[3]);
    QAND(a[1], b[1], d[1], d[3]);
    QAND(a[2], b[2], d[2], d[3]);
    ccx(a[3], b[3], d[3]);
    cx(b[1], b[0]);
    cx(a[1], a[0]);
    cx(a[3], a[2]);
...
void qt2_inv(qubit *a, qubit *b, qubit *d) {
    ...
    cx(b[1], b[0]);
    ccx(a[3], b[3], d[3]);
    QAND_inv(a[2], b[2], d[2]);
    QAND_inv(a[1], b[1], d[1]);
    QAND_inv(a[0], b[0], d[0]);
    cx(b[1], b[0]);
    cx(a[1], a[0]);
    cx(b[3], b[2]);
    cx(a[3], a[2]);
...
void get_qunatum_sbox4(uint8_t sbox[256], uint8_t delta = 0) {
	printf("Location: %s\n", __func__);
	for (int i = 0; i < 256; ++i) {
